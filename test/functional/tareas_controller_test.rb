...
class TareasControllerTest < ActionController::TestCase
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post :create, tarea: { cuerpo: @tarea.cuerpo, hecho: @tarea.hecho, titulo: @tarea.titulo, vencimiento: @tarea.vencimiento }
    end
  ...
  test "should update tarea" do
    put :update, id: @tarea, tarea: { cuerpo: @tarea.cuerpo, hecho: @tarea.hecho, titulo: @tarea.titulo, vencimiento: @tarea.vencimiento }
    assert_redirected_to tarea_path(assigns(:tarea))
  end
